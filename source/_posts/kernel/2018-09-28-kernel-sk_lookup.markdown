---
layout: post
title: "nulls_hlist原理 和 tcp连接查找"
date: 2018-09-28 01:33:00 +0800
comments: false
categories:
- 2018
- 2018~09
...
这也就是为什么`__inet_lookup_established`里需要两次INET_MATCH。因为第一次INET_MATCH到atomic_inc_not_zero之间有可能在另一个cpu上将sk放到freelist，然后sk又被其他连接alloc拿去用了
...
1.nulls hlist不再以NULL结尾，而以一个大到2^31空间的任意值结尾
...
本地下载 [do-not-touch-listener-sk_refcnt-under-synflood.patch](/download/kernel/do-not-touch-listener-sk_refcnt-under-synflood.patch)
