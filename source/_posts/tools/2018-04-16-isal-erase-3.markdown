---
layout: post
title: "伽罗华域（Galois Field）上的四则运算"
date: 2018-04-16 03:34:00 +0800
comments: false
categories:
- 2018
- 2018~04
...
![](/images/tools/2018-04-16-10.png)
...
### 三、伽罗华域
#### 1、有限域GF(p)：
有限域GF(p)，其中p为素数。GF(p)里面的加法和乘法与一般的加法和乘法差不多，区别是结果需要mod p，以保证结果都是域中的元素。GF(p)的加法和乘法单位元分别是 0和1。
...
![](/images/tools/2018-04-16-11.png)
...
![](/images/tools/2018-04-16-12.png)
